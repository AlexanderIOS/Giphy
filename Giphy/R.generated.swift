...
struct R: Rswift.Validatable {
  ...
  struct image {
    /// Image `favoriteWhite`.
    static let favoriteWhite = Rswift.ImageResource(bundle: R.hostingBundle, name: "favoriteWhite")
    
    /// Image `favoriteBlack`.
    static let favoriteBlack = Rswift.ImageResource(bundle: R.hostingBundle, name: "favoriteBlack")

    /// `UIImage(named: "favoriteWhite", bundle: ..., traitCollection: ...)`
    static func favoriteWhite(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
        return UIKit.UIImage(resource: R.image.favoriteWhite, compatibleWith: traitCollection)
    }
    
    /// `UIImage(named: "favoriteBlack", bundle: ..., traitCollection: ...)`
    static func favoriteBlack(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
        return UIKit.UIImage(resource: R.image.favoriteBlack, compatibleWith: traitCollection)
    }
    fileprivate init() {}
  }
